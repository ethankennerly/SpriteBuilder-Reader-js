...
badd +22 src\CCBReader_private.h
...
badd +227 \archive\cocos2d-html5\extensions\GUI\CCControlExtension\CCScale9Sprite.js
...
badd +0 ref\CCBReader10.m
badd +0 ref\CCBReader.m
badd +0 res\Normal\MainScene_10.ccbi
args README.md
edit README.md
...
silent! normal! zE
let s:l = 50 - ((0 * winheight(0) + 23) / 46)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 191 - ((0 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
191
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 241 - ((43 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
241
...
exe 'vert 2resize ' . ((&columns * 73 + 95) / 190)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
2629
normal zo
let s:l = 2636 - ((202 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2636
...
126
normal zo
let s:l = 344 - ((76 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
344
...
exe 'vert 1resize ' . ((&columns * 116 + 95) / 190)
exe 'vert 2resize ' . ((&columns * 73 + 95) / 190)
tabedit C:\archive\SpriteBuilder-Reader-js\ref\CCBReader.m
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit C:\archive\SpriteBuilder-Reader-js\ref\CCBReader10.m
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
exe 'vert 1resize ' . ((&columns * 58 + 95) / 190)
exe 'vert 2resize ' . ((&columns * 131 + 95) / 190)
tabedit C:\archive\SpriteBuilder-Reader-js\res\Normal\MainScene_10.ccbi
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
